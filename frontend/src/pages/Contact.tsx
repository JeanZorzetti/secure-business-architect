    ...
    <>
      ...
      <section className="bg-secondary py-16 mb-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fadeInUp">
            ...
            <span className="text-gradient block">Diagnóstico Estratégico</span>
          </h1>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="relative group bg-primary text-primary-foreground p-8 rounded-2xl shadow-elegant transition-all duration-500 hover:shadow-2xl overflow-hidden">
              {/* Shine effect */}
      ...
      <section className="container mx-auto px-4 mt-20">
        <motion.div
          ...
          className="relative group hero-gradient text-primary-foreground p-12 rounded-2xl text-center shadow-elegant max-w-3xl mx-auto transition-all duration-500 hover:shadow-2xl overflow-hidden"
        >
          {/* Animated Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
